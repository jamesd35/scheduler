...
<body>
	<!--div align="center"><h1>'Perfect' Preferences</h1></div-->
</body>
</html>
<?php
/* This file is used to show every tutor's perfect preferences for every hour of the week
 */
...
//Loops through the hoursByDay table and selects everybody who entered a 3
foreach($days as $weekDay){
	foreach($hours as $hrs){
