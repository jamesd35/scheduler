...
/*
	...
	This file walks the tutors through the various functions available to them
*/
   ...
   include "./../common/session_validator.php";
    ...
    if($employee_info[3] != 'grad' && $employee_info[3] != 'ugrad') {
...
The comment box can be used to submit any comments you wish the administrators to see when they are making your schedule.  You do not need
        ...
        <img src='pics/setHours.png' alt='Set Hours Image' width='550' height='400'>
        <br>
        <a href=''>Top</a>
        <br>
        <br>
	...
	<img src='pics/viewHours.png' alt='Set Hours Image' width='550' height='400'>
	<br>
	<a href=''>Top</a>
	<br>
	<br>
